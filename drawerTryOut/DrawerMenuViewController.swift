...
class DrawerMenuViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didDeselectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let mainView = UIStoryboard.init(name: "Main", bundle: nil).instantiateViewControllerWithIdentifier("gcStoryMain")
        let nav = UINavigationController.init(rootViewController: mainView)
        
        print("The row selected was number \(indexPath.row)")
        switch(indexPath.row){
            ...
            case 2 :
                ...
                break;
            case 3 :
                mainView.view.backgroundColor = UIColor.yellowColor()
                break;
            default:
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("dontReuse")
        return cell!
    }
    */
    /*
